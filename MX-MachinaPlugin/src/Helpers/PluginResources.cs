namespace Loupedeck.MXMachinaPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.MX-MachinaPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.MX-MachinaPlugin.Resources.Resource.txt`.
